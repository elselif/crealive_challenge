                                                            ...
                                                            <table class="table table-bordered" id="example1">
                                                                      ...
                                                                      <tbody>
                                                                                ...
                                                                                <tr>
                                                                                          ...
                                                                                          <td>
                                                                                                    <img src="{{asset('uploads/'.$row->post_photo)}}" alt="" width="200px">
                                                                                          </td>
                                                                                          ...
                                                                                          <td class="pt_10 pb_10">
                                                                                                    ...
                                                                                                    <a href="{{route('admin_post_delete' , $row->id)}}" class="btn btn-primary" onclick="return confirm('Are you sure?')">Delete</a>
                                                                                          </td>
                                                                                </tr>       
                                                                                @endforeach
                                                                      </tbody>

...
@section('button')
<a href="{{route('admin_sub_category_create')}}" class="btn btn-primary">
                                                                      ...
                                                                      <tbody>
                                                                                ...
                                                                                <tr>
                                                                                          ...
                                                                                          <td class="pt_10 pb_10">
                                                                                                    ...
                                                                                                    <a href="{{route('admin_sub_category_delete' , $row->id)}}" class="btn btn-primary" onclick="return confirm('Are you sure?')">Delete</a>
                                                                                          </td>
                                                                                </tr>       
                                                                                @endforeach
                                                                      </tbody>
